...
issueDate = ql.Date(11,4,2017)
maturityDate = ql.Date(11,4,2020)
vol_upper = .35
vol_lower = .365
div_yield = .04
...
data_matrix = [['Volcan I 4.125% 2020 Mandatory', ''],
...
py.iplot(table, filename='Mandatory_Convertibles/Volcan_I')
