# -*- coding: utf-8 -*-
"""
Created on Thu Oct 26 17:20:34 2017

Alibaba Mandatory
METUSA 5.75% 06/03/2019
...
mando_px = np.round(((risky_coupons+bond+call_ratio) - put_ratio), 3)
...
parity_points = np.round((mkt_px-current_parity()), 3)
...
print ('################################')
print ('Parity: %s' % np.round(current_parity(),3))
...
data_matrix = [['BABA 5.75% 2019 Mandatory', ''],
...
py.iplot(table, filename='Mandatory_Convertibles/BABA')
